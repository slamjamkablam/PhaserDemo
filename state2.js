...
demo.state2.prototype = {
    ...
    create: function(){
        ...
        enemyGroup.setAll('anchor.y',.5);
        enemyGroup.setAll('anchor.x',.5);
        enemyGroup.setAll('scale.y',.5);
        enemyGroup.setAll('scale.x',.5);
